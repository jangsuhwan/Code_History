...
void Insert_Head(List* list, LData data) //리스트 맨 앞에 삽입
{
...
void Find(List* list, LData data) //data찾는 메서드
{
...
void Insert_Before(List* list, LData data1, LData data2) //data1 앞에 data2 삽입
{
...
void Insert_After(List* list, LData data1, LData data2) //data1 뒤에 data2삽입
{
	Node* fNode = list->head;
	Node* newNode = (Node*)malloc(sizeof(Node));
	newNode->data = data2;
